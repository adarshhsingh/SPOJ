...
from what you might have expected, but also the sample output does not show the difference.
For an example, let us look at permutations.
A permutation of the integers 1 to n is an ordering of these integers. So the natural way to represent 
a permutation is to list the integers in this order.
...
To get rid of such annoying sample test cases, you have to write a program which detects if a given 
		...
		// TODO Auto-generated method stub
		 Scanner sc=new Scanner(System.in);
		    ...
		    while((n=sc.nextInt())!=0)
		    {
		    	...
		    	for(int i=1;i<=n;i++)
		    	{
		    		if(num[num[i]]!=i){flag=false;break;}
		    	}
